...
|---|---|---|
| [Name 1] | [Percentage]% | Code structure, Graph implementation, Graph loading |
| [Name 2] | [Percentage]% | Friend list algorithm, Input validation, Testing |
| [Name 3] | [Percentage]% | BFS algorithm, Path reconstruction, Debugging |
| [Name 4] | [Percentage]% | Report writing, Algorithm analysis, Quality assurance |
